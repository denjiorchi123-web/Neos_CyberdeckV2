  ...
  return (
    <ActionTooltip side="right" align="center" label="USB File Manager">
      <button
        ...
        aria-label="Open USB file manager"
        style={{ touchAction: "manipulation" }}
      >
        <div className={cn(
          "flex shrink-0 mx-3 h-12 w-12 rounded-[24px] group-hover:rounded-[14px] transition-all overflow-hidden items-center justify-center bg-background dark:bg-neutral-700 group-hover:bg-emerald-500",
